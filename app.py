...
from repositories.src.user_repository import user_repository_singleton
...
@app.get('/chatsession')
def chat():
    users = user_repository_singleton.get_all_users()
...
def handle_message(json):
    user = user_repository_singleton.get_user_by_id(active_user_id)
    if user:
